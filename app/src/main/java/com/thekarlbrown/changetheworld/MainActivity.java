...
public class MainActivity extends Activity implements IdeaDataAdapter.IdeaDataAdapterListener, ProfileTab.ProfileTabListener, IdeaPage.IdeaPageListener, DraftDataAdapter.DraftDataAdapterListener, SearchDialog.SearchDialogListener, RatioDialogue.NoticeRatioDialogListener, ThumbDialogue.NoticeThumbDialogListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void openTrending() {
        getJSONtoIdeaBlock("https://www.p8w9j4-user.freehosting.host/app_ideas/ideas_byAreaJSON.php?lat=" + latitude + "&long=" + longitude + "&state=" + state + "&country=" + country + "&username=" + username + "&case=2");
        fm = getFragmentManager();
        ft = fm.beginTransaction();
        b = new Bundle();
    ...
    public void onSearchDialogPositiveClick(String r) {
        if (r != null) {
            getJSONtoIdeaBlock("https://www.p8w9j4-user.freehosting.host/app_ideas/ideas_bySearchJSON.php?search=" + r);
            fm = getFragmentManager();
            ft = fm.beginTransaction();
    ...
    public void pullAreaBar(int area, String tag) {
        ...
        switch (tag) {
            case "trending":
                getJSONtoIdeaBlock("https://www.p8w9j4-user.freehosting.host/app_ideas/ideas_byAreaJSON.php?lat=" + latitude + "&long=" + longitude + "&state=" + state + "&country=" + country + "&username=" + username + "&case=" + area);
    ...
    public void pullTimeBar(int time, String tag) {
        ...
        switch (tag) {
            case "category":
                getJSONtoIdeaBlock("https://www.p8w9j4-user.freehosting.host/app_ideas/ideas_byCatSubTimeJSON.php?cat=" + (categoryTab.firstCategorySelected + 1) + "&sub=" + categoryTab.subcategorySelected + "&case=" + time);
    ...
    public boolean verifyLogon(String username, String password) {
		...
		aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/user_verifyPHash.php?username=" + username + "&password=" + password);
        try {
            aSyncParser.execute();
			jsonArray = aSyncParser.get();
        } catch (Exception e) {
    ...
    public boolean verifyCreate(String username, String password, String email) {
		...
		try {
            ...
            Log.println(0,"Error: ",e.toString());
        }aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/user_addPHash.php?username=" + username + "&password=" + password + "&email=" + email);
        try {
            aSyncParser.execute();
            jsonArray = aSyncParser.get();
        } catch (Exception e) {
    ...
    public boolean verifyAdd(String title, String description,int cat,int sub) {
        ...
        aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/idea_addJSON.php?title="+title+ "&username=" + username + "&descrip=" + description + "&cat=" + cat +"&sub="+sub+"&lat="+latitude+"&long="+longitude+"&state="+state+"&country="+country);
        try {
            aSyncParser.execute();
            jsonArray = aSyncParser.get();
        } catch (Exception e) {
    ...
    public boolean changeFollow(String follower,int choice) {
        ...
        aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/follower_JSON.php?&username=" + username + "&follower=" + follower + "&case=" + choice);
        try {
            aSyncParser.execute();
            jsonArray = aSyncParser.get();
        } catch (Exception e) {
    ...
    public void getFavRatD(String username, int ideaid) {
        ...
        aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/favratd_byUserJSON.php?ideaid=" + ideaid + "&username=" + username);
        try {
            aSyncParser.execute();
            jsonArray = aSyncParser.get();
        } catch (Exception e) {
    ...
    public void setFavRatD(String username, int ideaid, int selection) {
        ...
        aSyncParser = new ASyncParser("https://www.p8w9j4-user.freehosting.host/app_ideas/favratdJSON.php?username="+username+"&ideaid="+ideaid+"&case="+selection);
        try {
            aSyncParser.execute();
            jsonArray = aSyncParser.get();
        } catch (Exception e) {
